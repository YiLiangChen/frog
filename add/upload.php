      ...
      if($type == "image/jpeg" || $type == "image/jpg"){
        ...
        if($sizemb > 2){
          ...
          try{
            ...
            $pdo->exec($sql);
            $sql2 = "INSERT INTO exif(filename,photoTime,resolution,camera,aperture,exposure,isoSpeed,focalLength,saturation,whiteBalance)
            VALUES('".$name."','".$DateTime."','".$ResolutionUnit."','".$Model."','".$ApertureFNumber."','".$ExposureTime."','".$ISOSpeedRatings."','".$FocalLengthIn35mmFilm."','".$Saturation."','".$WhiteBalance."')" ;
            $pdo->exec($sql2);
            echo "檔案:".$name."上傳成功";
